CREATE TYPE "public"."profile_role" AS ENUM('owner', 'guardian', 'member');--> statement-breakpoint
CREATE TYPE "public"."profile_type" AS ENUM('personal', 'child', 'team');--> statement-breakpoint
...
CREATE UNIQUE INDEX "profile_members_profile_user_unique" ON "profile_members" USING btree ("profile_id","user_id");--> statement-breakpoint
CREATE INDEX "profile_members_user_idx" ON "profile_members" USING btree ("user_id");--> statement-breakpoint
CREATE INDEX "profile_members_user_active_idx" ON "profile_members" USING btree ("user_id","is_active");--> statement-breakpoint
CREATE INDEX "profiles_owner_user_idx" ON "profiles" USING btree ("owner_user_id");--> statement-breakpoint
